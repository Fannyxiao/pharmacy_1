...
<div class="top"><img src="images/yao_logo.jpg"></div>
	<div class="denglu box-shadow">
		...
		<div class="main-right">
		   	    ...
		   	    <div class="hi"><span>Hi!欢迎登录</span>
		   	    <br><span style="font-size:14px; color:red;">用户不存在!</span>
		   	    	<br>   	    </div>
		...
		<div class="denglu1">
			<div class="hi">
				<img src="images/weiba.png"
					style="width: 120px;height: 40px;vertical-align: middle;"><span>欢迎登陆小尾巴狼</span>
			</div>
			<center><span style="font-size:14px; color:red;">用户不存在!</span></center>
			<form action="User/User-login" method="post">
				<div id="fome1">
