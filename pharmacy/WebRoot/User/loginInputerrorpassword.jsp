...
<div class="top"><img src="images/yao_logo.jpg"></div>
	<div class="denglu box-shadow">
		...
		<div class="main-right">
		   	    ...
		   	    <div class="hi"><span>Hi!欢迎登录<br><span style="font-size:14px; color:red;">对不起您的密码有误</span></span></div>
	...
	<div class="denglu" style="display:none;">
		<div class="denglu1">
			<div class="hi">
				<img src="images/weiba.png"
					style="width: 120px;height: 40px;vertical-align: middle;"><span>欢迎登</span>
			</div>
			<center><span style="font-size:14px; color:red;">对不起您的密码有误，请重新输入!</span></center>
			<form action="User/User-login" method="post">
				<div id="fome1">
					<input class="fome11" type="text" name="user.username"
						value="请输入用户名" style="color:#888888; font-size:16px;"
						onfocus="javascript:this.style.color='#000000';if(this.value=='请输入用户名')this.value='';"
						onblur="javascript:if(this.value==''){this.value='请输入用户名';this.style.color='#888888';}" />
				</div>
				<div id="fome3">
					<input class="fome22" type="password" name="user.password"
						value="请输入密码" style="color:#888888; font-size:16px;"
						onfocus="javascript:this.style.color='#000000';if(this.value=='请输入密码')this.value='';"
						onblur="javascript:if(this.value==''){this.value='请输入密码';this.style.color='#888888';}" />
				</div>
				<div class="submit">
					<input type="submit" value="登陆" class="button blue"
						style="font-family: 'Microsoft Yahei' ;font-size: '15px';color: #F0F8FF;width: 202px;height: 42px;">
					<!-- <a href="#" class="button blue"
					style="font-family: 'Microsoft Yahei' ;font-size: '15px';color: #F0F8FF;width: 130px;height: 20px;">登
					陆</a> -->
				</div>
			</form>
		</div>
	...
	<!-- <form action="User/User-login" method="post">
		<ul>
			<li><input type="text" placeholder="请输入用户名" name="user.username"
				class="register1_input"></li>
			<li><input type="password" placeholder="请输入密码"
				name="user.password" class="register1_input"></li>
			<li><input type="submit" value="登陆" class="login_input"></li>
		</ul>
	</form> -->
</body>
</html>
